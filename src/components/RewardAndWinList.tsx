...
function RewardAnnouncement() {
  const { ref, scale } = useScaleToFit(REWARD_ANNOUNCEMENT_WIDTH);

  return (
    <div
      ref={ref}
      className="h-[438px] min-w-0 flex-[519_519_0%] overflow-hidden"
    >
      <div
        className="relative h-[438px] w-[519px] origin-top-left overflow-hidden rounded-tl-[50px] border-2 border-[#23f3d5] bg-white/50"
...
function WinList() {
  return (
    <div className="relative h-[438px] min-w-0 flex-[798_798_0%] overflow-hidden rounded-br-[70px]" style={{ backgroundImage: WIN_LIST_BG_GRADIENT }}>
