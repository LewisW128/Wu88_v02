import iconTitlePromo from "../assets/promotions/icon-title.svg";
import btnBgPromo from "../assets/promotions/btn-bg.svg";
import vectorArrow from "../assets/promotions/vector1.svg";
import pirateBg from "../assets/promotions/pirate-bg.png";
import pirate from "../assets/promotions/pirate.png";
import badgeVectorA from "../assets/promotions/vector2.svg";
import badgeVectorB from "../assets/promotions/vector3.svg";
import badgeVectorC from "../assets/promotions/vector4.svg";
import football from "../assets/promotions/football.png";
import gclass from "../assets/promotions/gclass.png";

import iconTitleBiz from "../assets/business/icon-title.svg";
import arrowLeftBiz from "../assets/business/arrow-left.svg";
import arrowRightBiz from "../assets/business/arrow-right.svg";
import ellipseBiz from "../assets/business/ellipse.svg";

import serviceBtnBg from "../assets/service/btn-bg.svg";
import serviceVector from "../assets/service/vector.svg";
  ...
  return (
    <div className="absolute bottom-[20px] left-[20px] h-[53px] w-[128px]">
      <div className="pointer-events-none absolute inset-[-18.41%_-7.81%_-55.27%_-23.44%]">
        <img alt="" src={btnBgPromo} className="block size-full max-w-none" />
      </div>
      <div className="absolute inset-[24.53%_11.72%_30.19%_11.72%] flex items-center justify-between">
        ...
        <img alt="" src={vectorArrow} className="h-[10px] w-[26px]" />
      </div>
    </div>
  );
}
    ...
    <div className="flex w-full flex-col gap-[20px]">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-[10px]">
          <img alt="" src={iconTitlePromo} className="size-[45px]" />
        ...
        <div className="flex items-center gap-[10px]">
          ...
          <img alt="" src={vectorArrow} className="h-[13px] w-[33px]" />
        </div>
      </div>
...
function Business() {
  return (
    <div className="flex w-full flex-col gap-[20px]">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-[10px]">
          <img alt="" src={iconTitleBiz} className="size-[45px]" />
        ...
        <div className="flex items-center gap-[10px]">
          <button className="flex h-[45px] items-center justify-center rounded-full border border-[#dadada] bg-white/25 px-[20px] backdrop-blur-[10px]">
            <img alt="" src={arrowLeftBiz} className="h-[13px] w-[24px]" />
          </button>
          <button className="flex h-[45px] items-center justify-center rounded-full border border-[#23f3d5] bg-[rgba(35,243,213,0.8)] px-[20px] backdrop-blur-[10px]">
            <img alt="" src={arrowRightBiz} className="h-[13px] w-[24px]" />
          </button>
        </div>
      </div>
      <div className="relative flex h-[164px] w-full items-center gap-[50px] overflow-hidden rounded-br-[50px] rounded-tl-[50px] border border-[#dadada] px-[30px]">
        <img alt="" src={ellipseBiz} className="pointer-events-none absolute -right-[110px] -top-[30px] size-[366px]" />
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[40px] left-[20px] h-[53px] w-[244px]">
        <img alt="" src={serviceBtnBg} className="pointer-events-none absolute inset-[-18.63%_-4.1%_-55.91%_-12.3%] block max-w-none size-full" />
        <div className="absolute inset-0 flex items-center justify-center gap-[10px]">
          ...
          <img alt="" src={serviceVector} className="h-[8px] w-[21px]" />
        </div>
      </div>
    </div>
  );
