...
import wu88LogoUnion from "../assets/recommend/wu88-logo-union.svg";
import wu88LogoMask from "../assets/recommend/wu88-logo-mask.svg";
import arrowChevronWhite from "../assets/shared/arrow-chevron-white.svg";
import shulaibao from "../assets/recommend/shulaibao.png";
import products from "../assets/recommend/products.png";
import tiaoqilaiOverlay from "../assets/recommend/tiaoqilai-overlay.png";
import hudaole from "../assets/recommend/hudaole.png";
import feitiancaishen from "../assets/recommend/feitiancaishen.png";
import pijiupaidui from "../assets/recommend/pijiupaidui.png";
import huoshaolianhuanchuan from "../assets/recommend/huoshaolianhuanchuan.png";
import faifushen from "../assets/recommend/faifushen.png";
...
export default function Recommend() {
  ...
  return (
    ...
    >
      <img alt="WU88" src={wu88LogoUnion} className="absolute left-[20px] top-[20px] h-[42px] w-[131px]" />
      <img alt="" src={wu88LogoMask} className="absolute left-[102px] top-[38px] h-[24px] w-[49px]" />
      ...
      <div className="flex items-center justify-end gap-[10px] py-[5px] pr-[40px]">
        ...
        <img alt="" src={arrowChevronWhite} className="h-[13px] w-[8px]" />
      </div>
      ...
      <div ref={scrollRef} className="scrollbar-hide mt-[24px] flex gap-[20px] overflow-x-auto pl-[60px] pb-[10px] drop-shadow-[0px_40px_20px_rgba(0,0,0,0.25)]">
        <Card main="鼠來寶" sub="SLOT" badge="HOT" specialShape>
          <img alt="" src={shulaibao} className="absolute inset-0 size-full object-cover" />
        </Card>

        <Card main="魔龍傳奇" sub="SLOT" badge={null}>
          <img alt="" src={products} className="absolute inset-0 size-full object-cover" />
        </Card>

        <Card main="跳起來" sub="SLOT" badge="NEW" specialShape>
          <img alt="" src={products} className="absolute inset-0 size-full object-cover blur-[18px]" />
          <img alt="" src={tiaoqilaiOverlay} className="absolute left-1/2 top-0 h-full w-full -translate-x-1/2 object-cover" />
        </Card>

        <Card main="胡到了" sub="SLOT" badge="HOT" specialShape>
          <div className="absolute inset-0 bg-[#f269ff]" />
          <img alt="" src={hudaole} className="absolute left-0 top-[20px] h-[200px] w-[200px] object-cover" />
        </Card>
        ...
        <Card main="啤酒派對" sub="SLOT" badge={null}>
          ...
          <img alt="" src={pijiupaidui} className="absolute left-1/2 top-[calc(50%-20px)] h-[200px] w-[200px] -translate-x-1/2 -translate-y-1/2 object-cover" />
        </Card>
        ...
        <Card main="發福神" sub="SLOT" badge={null}>
          ...
          <img alt="" src={faifushen} className="absolute left-0 top-[calc(50%-20px)] h-[200px] w-[200px] -translate-y-1/2 object-cover" />
        </Card>
      </div>
